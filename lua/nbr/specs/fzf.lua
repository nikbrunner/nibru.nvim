...
M.keys = function()
    ...
    return {
        ...
        { "<leader>a?t",      function() fzfLua.help_tags() end, desc = "[T]ags" },
        { "<leader>a?m",      function() fzfLua.man_pages() end, desc = "[M]an Pages" },
        { "<leader>a?h",      function() fzfLua.highlights() end, desc = "[H]ighlights" },
