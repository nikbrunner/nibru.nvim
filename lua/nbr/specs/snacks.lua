...
return {
    ...
    keys = function()
        ...
        return {
            ...
            { "<leader>ag",          function() Snacks.lazygit() end, desc = "[G]it Control" },
            { "<leader>wg",          function() Snacks.lazygit.log() end, desc = "[G]it Control" },
            { "<leader>dg",          function() Snacks.lazygit.log_file() end, desc = "[G]it Control" },
            ...
            { "<leader>sb",          function() Snacks.git.blame_line() end, desc = "[B]lame" },
            {
                "<leader>aN",
                desc = "[N]ews",
                function()
